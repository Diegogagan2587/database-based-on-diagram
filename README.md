...
> **Database based on diagram** This is a project where we create a database based on a diagram, making use of many-to-many relationships, one-to-many and many-to-one, creating join tables and primary keys for all the required rows.
...
Feel free to check the [issues page](https://github.com/Diegogagan2587/database-based-on-diagram/issues).
